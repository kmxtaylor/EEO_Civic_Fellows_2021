							...
							<div class="acsNSBootstrap acs_np form-group" style="font-weight:normal;">
								<div class="acs_content row">
									<div class="accordionControl">
										<button type="button" id="openAccordions">Show All</button>
										<button type="button" id="closeAccordions">Hide All</button>	
									</div>						
								<!-- </div> -->
								...
								<div class="accordion">
									<button type="button" class="accordionHeader">
										...
										<span>Detailed Census Occupation by Sex and Race/Ethnicity</span>
									</button>
								...
								<div class="accordion">
									<button type="button" class="accordionHeader">
										<!-- <span class="accordionIcon">+ </span> -->
										<span class="accordionIcon o-angle-down-1"></span>
										<span>EEO Occupational Groups by Sex and Race/Ethnicity (incl. Citizenship)</span>
									</button>
									<div class="accordionContent">
										<div class="acs_content col-xs-12">
								...
								<div class="accordion">
									<button type="button" class="accordionHeader">
										<!-- <span class="accordionIcon">+ </span> -->
										<span class="accordionIcon o-angle-down-1"></span>
										<span>Federal Sector Job Groups by Sex and Race/Ethnicity (incl. Citizenship)</span>
									</button>
									<div class="accordionContent">
										<div class="acs_content col-xs-12">
								...
								<div class="accordion">
									<button type="button" class="accordionHeader">
										<!-- <span class="accordionIcon">+ </span> -->
										<span class="accordionIcon o-angle-down-1"></span>
										<span>State and Local Government Job Groups by Sex and Race/Ethnicity (incl. Citizenship)</span>
									</button>
									<div class="accordionContent">
										<div class="acs_content col-xs-12">
...
<option value="04000us56" disabled="" class="eeo_red" >Wyoming (no places available)</option>
									...
									</div>   <!--missing ">" at the end of this div tag  -->
...
<div class="row" id="eeo_index_docu" style="display:block; margin-top:25px; border-top:1px dotted #333;">
								...
								<p class="acs_eeo_L_30"><a href="https://www2.census.gov/programs-surveys/demo/guidance/eeo/EEO-2014-2018-Occupation-Crosswalk-to-Other-Occupations-Groups-2.22.2021.xlsx">2014-2018 EEO Occupation Code List (xlsx)</a>  </p>
							
								<p class="acs_eeo_L_30"><a href="https://www2.census.gov/programs-surveys/demo/guidance/eeo/EEO-Occupation-Crosswalk-051221.xlsx">Crosswalk of EEO 2006-2010 Occupations to EEO 2014-2018 Occupations (xlsx)</a></p>
								
								
								<p class="acs_eeo" >For additional information concerning changes to the Census codes lists, see the technical paper: </p>
								<p class="acs_eeo_L_30" ><a href="https://www.census.gov/library/publications/2020/demo/acs-tp78.html">Changes in the Census Industry and Occupation Classification Systems</a> </p>
								...
								(see the <a href="https://www.census.gov/topics/employment/equal-employment-opportunity-tabulation.html">Equal Opportunity Tabulation subject page</a>  ). Additional resources include occupation and industry code lists, 
								table titles and content, crosswalks, geography links, FTP links, and Frequently Asked Questions. 

									<p class="acs_eeo_L_30"><a href="https://www.census.gov/topics/employment/equal-employment-opportunity-tabulation/guidance/2014-2018-eeo.html">2014-2018 EEO Tabulation Guidance</a>  </p>
									<p class="acs_eeo_L_30"><a href="https://www.census.gov/topics/employment/equal-employment-opportunity-tabulation/about/faq.html">2014-2018 EEO Tabulation FAQs</a>  </p>
